...
- 2026-08-29 当前复核：`docs/latest-project-audit.md` LP-001～LP-010 已完成；共享参数绑定、Property 输出和 GUI 关键控件行为已补真实测试。T-630 的 `[~]` 仅保留给真实桌面 1200x800 / 800x500 截图人工验收，不再把它与代码功能是否接线混为一谈；自动化全解方案当前为 2131 通过 / 2 跳过 / 0 失败。
